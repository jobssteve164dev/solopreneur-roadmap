...
<head>
  ...
  <style>
    ...
    .workbench-room .collaboration-layout{width:100%;min-height:620px;margin:0;display:grid;grid-template-columns:240px minmax(0,1fr);gap:20px;padding:0}.workbench-room .room-shell{min-height:620px;border-radius:16px;box-shadow:none}.workbench-room .recent{border-radius:16px;background:var(--glass-bg)}@media(max-width:760px){.workbench-room .collaboration-layout{display:block;min-height:0}.workbench-room .recent{margin-bottom:12px}.workbench-room .room-shell{min-height:620px}}
